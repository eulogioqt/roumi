    ...
    return (
        <div className="px-5 py-5 mt-5 w-100">
            <div className="text-center mb-5">
                <h1 className="fw-bold display-4">RoUMI</h1>
            ...
            <div className="mx-auto mb-5 p-4 rounded shadow-sm border bg-white" style={{ maxWidth: "900px" }}>
                ...
                <p className="mb-0 text-muted">
                    Integrada dentro de arquitecturas basadas en ROS 2, RoUMI proporciona una solución robusta, extensible y fácilmente desplegable para la gestión de identidades en sistemas HRI. Su diseño modular y su enfoque práctico la convierten en una herramienta eficaz para investigadores y desarrolladores que trabajan con robots sociales o entornos interactivos.
                </p>
            </div>
